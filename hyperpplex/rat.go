...
// A Rat is a hyper-perplex number with big.Rat components.
type Rat struct {
	l, r dualpplex.Rat
}
...
// then it returns z.
func (z *Rat) SetPair(a, b *dualpplex.Rat) *Rat {
	z.l.Set(a)
	z.r.Set(b)
	return z
}

// NewRat returns a pointer to the Rat value a+bs+cΓ+dsΓ+eΛ+fsΛ+gΓΛ+hsΓΛ.
...
func (z *Rat) Mul(x, y *Rat) *Rat {
	a, b, temp := new(dualpplex.Rat), new(dualpplex.Rat), new(dualpplex.Rat)
	a.Mul(&x.l, &y.l)
	b.Add(
		b.Mul(&x.l, &y.r),
		temp.Mul(&x.r, &y.l),
