...
// A Rat is an ultra-perplex number with big.Rat components.
type Rat struct {
	l, r superpplex.Rat
}
...
// then it returns z.
func (z *Rat) SetPair(a, b *superpplex.Rat) *Rat {
	z.l.Set(a)
	z.r.Set(b)
	return z
}

// NewRat returns a pointer to the Rat value a+bs+cρ+dσ+eτ+fυ+gφ+hψ.
...
func (z *Rat) Mul(x, y *Rat) *Rat {
	a, b, temp := new(superpplex.Rat), new(superpplex.Rat), new(superpplex.Rat)
	a.Mul(&x.l, &y.l)
	b.Add(
		b.Mul(&y.r, &x.l),
