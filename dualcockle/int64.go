...
// An Int64 is an dual-Cockle quaternion with int64 components.
type Int64 struct {
	l, r cockle.Int64
}
...
// NewInt64 returns a pointer to the Int64 value a+bi+ct+du+eΓ+fiΓ+gtΓ+huΓ.
...
func (z *Int64) Quad() *nplex.Int64 {
	...
	q.Dilate(q, 2)
	return nplex.NewInt64(z.l.Quad(), q.Real())
}
