...
// A Float is a Hamilton quaternion with big.Float components.
type Float struct {
	l, r cplex.Float
}
...
// NewFloat returns a pointer to the Float value a+bi+cj+dk.
...
func (z *Float) Lipschitz(a, b, c, d *big.Int) *Float {
	z.l.Gauss(a, b)
	z.r.Gauss(c, d)
	return z
}
...
// and returns z.
func (z *Float) Hurwitz(a, b, c, d *big.Int) *Float {
	z.Lipschitz(a, b, c, d)
	half := big.NewFloat(0.5)
	return z.Add(z, NewFloat(half, half, half, half))
}
