...
// A Float64 is a Zorn octonion with float64 components.
type Float64 struct {
...
//
// If z corresponds to a+bi+cj+dk+er+fs+gt+hu, then the string is
// "(a+bi+cj+dk+er+fs+gt+hu)", similar to complex128 values.
...
// SetPair sets z equal to a Zorn octonion made with a given pair, and
// then it returns z.
...
// NewFloat64 returns a pointer to the Float64 value a+bi+cj+dk+er+fs+gt+hu.
