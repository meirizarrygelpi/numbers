...
// A Float64 is an perplex-Cockle quaternion with float64 components.
type Float64 struct {
	l, r cockle.Float64
}
...
// NewFloat64 returns a pointer to the Float64 value a+bi+ct+du+eS+fiS+gtS+huS.
