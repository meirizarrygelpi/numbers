...
// A Float is an perplex-Cockle quaternion with big.Float components.
type Float struct {
	l, r cockle.Float
}
...
// NewFloat returns a pointer to the Float value a+bi+ct+du+eS+fiS+gtS+huS.
