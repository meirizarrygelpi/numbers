...
// A Rat is a three-dimensional Grassmann number with big.Rat components.
type Rat struct {
	l, r grassmann2.Rat
}
...
// then it returns z.
func (z *Rat) SetPair(a, b *grassmann2.Rat) *Rat {
	z.l.Set(a)
	z.r.Set(b)
	return z
}
...
// z.
func (z *Rat) Set1Blades(aW, aX, aY *big.Rat) *Rat {
...
// returns z.
func (z *Rat) Set2Blades(aWX, aWY, aXY *big.Rat) *Rat {
	z.l.Set2Blade(aWX)
...
func (z *Rat) Set3Blade(aWXY *big.Rat) *Rat {
	z.r.Set2Blade(aWXY)
	return z
}
...
func (z *Rat) Hodge(y *Rat) *Rat {
	a, b := new(grassmann2.Rat), new(grassmann2.Rat)
	a.Set(&y.l)
	b.Set(&y.r)
...
func (z *Rat) Mul(x, y *Rat) *Rat {
	a, b, temp := new(grassmann2.Rat), new(grassmann2.Rat), new(grassmann2.Rat)
	a.Mul(&x.l, &y.l)
	b.Add(
		b.Mul(&y.r, &x.l),
