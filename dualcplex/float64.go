...
// A Float64 is a dual-complex number with float64 components.
type Float64 struct {
	l, r cplex.Float64
}
...
// NewFloat64 returns a pointer to the Float64 value a+bi+cΓ+diΓ.
...
// 		Mul(j, k) = -Mul(k, j) = i
// 		Mul(k, i) = -Mul(i, k) = j
// This binary opeFloat64ion is commutative and associative.
