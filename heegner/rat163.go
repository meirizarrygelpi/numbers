...
//
// If z corresponds to a + b√−163, then the string is "⦗a+b√−163⦘", similar to
// complex128 values.
...
// NewRat163 returns a pointer to the Rat163 value a+b√−163.
...
// Quad returns the quadrance of z. If z = a+b√−163, then the quadrance is
// 		a² + 163b²
