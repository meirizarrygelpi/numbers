...
//
// If z corresponds to a + b√−43, then the string is "⦗a+b√−43⦘", similar to
// complex128 values.
...
// NewRat43 returns a pointer to the Rat43 value a+b√−43.
...
// Quad returns the quadrance of z. If z = a+b√−43, then the quadrance is
// 		a² + 43b²
...
// 		(a*y + b) * Inv(c*y + d)
// Then it returns z.
func (z *Rat43) Möbius(y, a, b, c, d *Rat43) *Rat43 {
	z.Mul(a, y)
	z.Add(z, b)
	temp := new(Rat43)
	temp.Mul(c, y)
...
// and returns z.
func (z *Rat43) Padé(y *Rat43, r *pade.Rat) *Rat43 {
