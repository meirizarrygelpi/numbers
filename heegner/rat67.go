...
//
// If z corresponds to a + b√−67, then the string is "⦗a+b√−67⦘", similar to
// complex128 values.
...
// NewRat67 returns a pointer to the Rat67 value a+b√−67.
...
// Quad returns the quadrance of z. If z = a+b√−67, then the quadrance is
// 		a² + 67b²
