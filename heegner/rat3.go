...
//
// If z corresponds to a + b√−3, then the string is "⦗a+b√−3⦘", similar to
// complex128 values.
...
// NewRat3 returns a pointer to the Rat3 value a+b√−3.
...
// Quad returns the quadrance of z. If z = a+b√−3, then the quadrance is
// 		a² + 3b²
