...
// An Int64 is a hyper-complex number with int64 components.
type Int64 struct {
	l, r dualcplex.Int64
}
...
// "⦗a+bi+cΓ+diΓ+eΛ+fiΛ+gΓΛ+hiΓΛ⦘", similar to complex128 values.
...
// then it returns z.
func (z *Int64) SetPair(a, b *dualcplex.Int64) *Int64 {
	z.l.Set(a)
	z.r.Set(b)
	return z
}

// NewInt64 returns a pointer to the Int64 value a+bi+cΓ+diΓ+eΛ+fiΛ+gΓΛ+hiΓΛ.
...
func (z *Int64) Mul(x, y *Int64) *Int64 {
	a, b, temp := new(dualcplex.Int64), new(dualcplex.Int64), new(dualcplex.Int64)
	a.Mul(&x.l, &y.l)
	b.Add(
		b.Mul(&x.l, &y.r),
		temp.Mul(&x.r, &y.l),
...
func (z *Int64) Quad() *dualcplex.Int64 {
	q := new(dualcplex.Int64)
