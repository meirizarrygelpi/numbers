...
// A Rat is a hyper-complex number with big.Rat components.
type Rat struct {
	l, r dualcplex.Rat
}
...
// then it returns z.
func (z *Rat) SetPair(a, b *dualcplex.Rat) *Rat {
	z.l.Set(a)
	z.r.Set(b)
	return z
}

// NewRat returns a pointer to the Rat value a+bi+cΓ+diΓ+eΛ+fiΛ+gΓΛ+hiΓΛ.
...
func (z *Rat) Mul(x, y *Rat) *Rat {
	a, b, temp := new(dualcplex.Rat), new(dualcplex.Rat), new(dualcplex.Rat)
	a.Mul(&x.l, &y.l)
	b.Add(
		b.Mul(&x.l, &y.r),
		temp.Mul(&x.r, &y.l),
