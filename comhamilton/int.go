...
// An Int is an complex-Hamilton quaternion with big.Int components.
type Int struct {
	l, r hamilton.Int
}
...
// NewInt returns a pointer to the Int value a+bi+cj+dk+eH+fiH+gjH+hkH.
...
func (z *Int) Quad() *cplex.Int {
	...
	return cplex.NewInt(quad.Sub(quad, z.r.Quad()), q.Real())
}
