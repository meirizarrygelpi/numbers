...
// A Float is an complex-Hamilton quaternion with big.Float components.
type Float struct {
	l, r hamilton.Float
}
...
// NewFloat returns a pointer to the Float value a+bi+cj+dk+eH+fiH+gjH+hkH.
...
func (z *Float) Quad() *cplex.Float {
	...
	return cplex.NewFloat(quad.Sub(quad, z.r.Quad()), q.Real())
}
