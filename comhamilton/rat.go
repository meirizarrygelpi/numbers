...
// A Rat is an complex-Hamilton quaternion with big.Rat components.
type Rat struct {
	l, r hamilton.Rat
}
...
// NewRat returns a pointer to the Rat value a+bi+cj+dk+eH+fiH+gjH+hkH.
...
func (z *Rat) Quad() *cplex.Rat {
	...
	return cplex.NewRat(quad.Sub(quad, z.r.Quad()), q.Real())
}
