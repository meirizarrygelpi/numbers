...
// An Int is an perplex-Hamilton quaternion with big.Int components.
type Int struct {
	l, r hamilton.Int
}
...
// NewInt returns a pointer to the Int value a+bi+cj+dk+eS+fiS+gjS+hkS.
...
func (z *Int) Quad() *pplex.Int {
	...
	return pplex.NewInt(quad.Add(quad, z.r.Quad()), q.Real())
}
