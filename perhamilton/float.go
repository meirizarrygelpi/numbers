...
// A Float is an perplex-Hamilton quaternion with big.Float components.
type Float struct {
	l, r hamilton.Float
}
...
// NewFloat returns a pointer to the Float value a+bi+cj+dk+eS+fiS+gjS+hkS.
...
func (z *Float) Quad() *pplex.Float {
	...
	return pplex.NewFloat(quad.Add(quad, z.r.Quad()), q.Real())
}
