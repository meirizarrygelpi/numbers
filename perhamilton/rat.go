...
// A Rat is an perplex-Hamilton quaternion with big.Rat components.
type Rat struct {
	l, r hamilton.Rat
}
...
// NewRat returns a pointer to the Rat value a+bi+cj+dk+eS+fiS+gjS+hkS.
